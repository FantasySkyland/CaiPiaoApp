            ...
            switch (resultBean.getLottery_id()){
                case "dlt":
                    ...
                    SpannableString spannableString = new SpannableString(
                            String.format(Locale.ENGLISH,"%s       期数：%s",stringBuilder.toString(),resultBean.getLottery_no()));
                    ...
                    break;
                    default:
                        tv_data.setText( String.format(Locale.ENGLISH,"%s       期数：%s",resultBean.getLottery_res(),resultBean.getLottery_no()));
            }
